...
> Citation: Kristina Black, J. P. Rippe, and Mikhail Matz. 2024 "RDA-forest: the next step after RDA-based genotype-environment associaton analysis", in submission.
...
```
![variable selection results](agaricia_yellow_mtrySelJack_feb.png)
...
```
![importances boxplot](agaricia_yellow_importances_feb.png)
...
![A.agaricites "yellow" lineage adaptation map](agaricia_yellow_rasters_feb1.png) 
...
![A.agaricites "yellow" lineage adaptation map,clustered](agaricia_yellow_rasters_clust_feb1.png) 
