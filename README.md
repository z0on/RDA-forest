...
The RDA-forest functions come in the form of an R package, `RDAforest_2.3.0.tar.gz`. To install it, run this in Rstudio
```R
install.packages("/path/to/downloaded/file/RDAforest_2.3.0.tar.gz")
library(RDAforest)
```
