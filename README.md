...
- Alternatively, "ordination jackknife" rebuilds the ordination multiple times based on a set fraction (default 0.75) of all samples and reruns the analysis. This more directly tests whether the PCs depend on chance configuration of samples.
