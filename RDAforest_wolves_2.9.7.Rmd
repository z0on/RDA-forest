...
mm=mtrySelJack(Y=cordist,X=env,covariates=latlon.gcd,nreps=25, prop.positive.cutoff=0.5,top.pcs=tokeep,ncores=12)
```
...
res=ordinationJackknife(Y=cordist,X=env[,mm$goodvars],covariates=latlon.gcd,nreps=25,top.pcs=tokeep,
                        newX=list(present=envc,future=envf),extra=c(0.1,0.2),ncores=12)
...
\
```{r results='hide', message=FALSE, warning=FALSE}
oj0=ordinationJackknife(Y=cordist0,X=env[-i,mm$goodvars],newX=envc,covariates=latlon.gcd[-i,],nreps=30,top.pcs=tokeep,extra=0.1,ncores=12)
```
